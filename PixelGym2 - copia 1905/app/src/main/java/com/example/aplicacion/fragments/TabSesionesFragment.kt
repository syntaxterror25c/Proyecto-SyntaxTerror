...
import com.example.aplicacion.databinding.FragmentTabListReservasBinding // Puedes renombrar el XML a fragment_tab_sesiones si quieres
...
class TabSesionesFragment : Fragment() {
    ...
    private var _binding: FragmentTabListReservasBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTabListReservasBinding.inflate(inflater, container, false)
        return binding.root
    }
